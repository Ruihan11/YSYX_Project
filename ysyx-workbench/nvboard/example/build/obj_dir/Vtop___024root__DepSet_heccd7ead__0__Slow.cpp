...
VL_ATTR_COLD void Vtop___024root___eval_initial(Vtop___024root* vlSelf) {
    ...
    vlSelf->__Vtrigrprev__TOP__top__DOT__my_led__DOT__en 
        = vlSelf->top__DOT__my_led__DOT__en;
    vlSelf->__Vtrigrprev__TOP__top__DOT__my_led__DOT__reset 
        = vlSelf->top__DOT__my_led__DOT__reset;
...
#endif
                VL_FATAL_MT("/home/ruihan11/Documents/YSYX_Project/ysyx-workbench/nvboard/example/vsrc/LFSR/top.v", 1, "", "Settle region did not converge.");
            }
...
VL_ATTR_COLD void Vtop___024root___dump_triggers__act(Vtop___024root* vlSelf) {
    ...
    if (vlSelf->__VactTriggered.at(0U)) {
        VL_DBG_MSGF("         'act' region trigger index 0 is active: @(posedge top.my_led.en or posedge top.my_led.reset)\n");
    }
...
VL_ATTR_COLD void Vtop___024root___dump_triggers__nba(Vtop___024root* vlSelf) {
    ...
    if (vlSelf->__VnbaTriggered.at(0U)) {
        VL_DBG_MSGF("         'nba' region trigger index 0 is active: @(posedge top.my_led.en or posedge top.my_led.reset)\n");
    }
...
VL_ATTR_COLD void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    vlSelf->seg6 = 0;
    vlSelf->seg7 = 0;
    vlSelf->top__DOT__my_led__DOT__en = 0;
    vlSelf->top__DOT__my_led__DOT__reset = 0;
    vlSelf->top__DOT__my_led__DOT__dout = 0;
    ...
    vlSelf->top__DOT__my_seg__DOT__hex0 = 0;
    vlSelf->top__DOT__my_seg__DOT__hex1 = 0;
    for (int __Vi0 = 0; __Vi0 < 524288; ++__Vi0) {
        vlSelf->top__DOT__my_vmem__DOT__vga_mem[__Vi0] = 0;
    }
    vlSelf->__Vtrigrprev__TOP__top__DOT__my_led__DOT__en = 0;
    vlSelf->__Vtrigrprev__TOP__top__DOT__my_led__DOT__reset = 0;
